...
const districtMap: Record<string, string[]> = {
  ...
  Adıyaman: [
    'Adıyaman Merkez', 'Besni', 'Çelikhan', 'Gerger', 'Gölbaşı', 'Kahta',
    'Samsat', 'Sincik', 'Tut',
  ],
  Afyonkarahisar: [
  ...
  Artvin: [
    'Ardanuç', 'Arhavi', 'Artvin Merkez', 'Borçka', 'Hopa', 'Kemalpaşa', 'Murgul', 'Şavşat', 'Yusufeli',
  ],
  Aydın: [
  ...
  Burdur: [
    'Ağlasun', 'Altınyayla', 'Bucak', 'Burdur Merkez', 'Çavdır', 'Çeltikçi', 'Gölhisar', 'Karamanlı', 'Kemer', 'Tefenni', 'Yeşilova',
  ],
  Bursa: [
  ...
  Çanakkale: [
    'Ayvacık', 'Bayramiç', 'Biga', 'Bozcaada', 'Çan', 'Çanakkale Merkez', 'Eceabat', 'Ezine',
    'Gelibolu', 'Gökçeada', 'Lapseki', 'Yenice',
  ],
  Çankırı: [
    'Atkaracalar', 'Bayramören', 'Çankırı Merkez', 'Eldivan', 'Ilgaz', 'Kızılırmak',
    'Korgun', 'Kurşunlu', 'Orta', 'Şabanözü', 'Yapraklı',
  ],
  Çorum: [
    'Alaca', 'Bayat', 'Boğazkale', 'Çorum Merkez', 'Dodurga', 'İskilip', 'Kargı', 'Laçin',
  ...
  Elazığ: [
    'Ağın', 'Alacakaya', 'Arıcak', 'Baskil', 'Elazığ Merkez', 'Karakoçan', 'Keban', 'Kovancılar',
    'Maden', 'Palu', 'Sivrice',
  ],
  Erzincan: [
    'Çayırlı', 'Erzincan Merkez', 'İliç', 'Kemah', 'Kemaliye', 'Otlukbeli', 'Refahiye', 'Tercan', 'Üzümlü',
  ],
  Erzurum: [
  ...
  Giresun: [
    ...
    'Giresun Merkez', 'Görele', 'Güce', 'Keşap', 'Piraziz', 'Şebinkarahisar', 'Tirebolu', 'Yağlıdere',
  ],
  Gümüşhane: [
    'Gümüşhane Merkez', 'Kelkit', 'Köse', 'Kürtün', 'Şiran', 'Torul',
  ],
  Hakkari: [
    'Çukurca', 'Derecik', 'Hakkari Merkez', 'Şemdinli', 'Yüksekova',
  ],
  Hatay: [
    'Altınözü', 'Antakya', 'Arsuz', 'Belen', 'Dörtyol', 'Erzin', 'Hassa', 'İskenderun',
    'Kırıkhan', 'Kumlu', 'Payas', 'Reyhanlı', 'Samandağ', 'Serinyol', 'Yayladağı',
  ],
  Isparta: [
  ...
  Kütahya: [
    ...
    'Hisarcık', 'Kütahya Merkez', 'Pazarlar', 'Şaphane', 'Simav', 'Tavşanlı',
  ],
  Malatya: [
  ...
  Sakarya: [
    ...
    'Karapürçek', 'Karasu', 'Kaynarca', 'Kocaali', 'Mithatpaşa', 'Pamukova',
    'Sapanca', 'Serdivan', 'Söğütlü', 'Taraklı',
  ],
  Samsun: [
    'Alaçam', 'Asarcık', 'Atakum', 'Ayvacık', 'Bafra', 'Canik', 'Çarşamba', 'Havza',
    'İlkadım', 'Kavak', 'Ladik', 'Ondokuzmayıs', 'Salıpazarı', 'Tekkeköy', 'Terme', 'Vezirköprü', 'Yakakent',
  ],
  Siirt: [
    'Baykan', 'Eruh', 'Kurtalan', 'Pervari', 'Siirt Merkez', 'Şirvan', 'Tillo',
  ],
  Sinop: [
    'Ayancık', 'Boyabat', 'Dikmen', 'Durağan', 'Erfelek', 'Gerze', 'Saraydüzü', 'Sinop Merkez', 'Türkeli',
  ],
  Sivas: [
    'Akıncılar', 'Altınyayla', 'Divriği', 'Doğanşar', 'Gemerek', 'Gölova', 'Gürun',
    'Hafik', 'İmranlı', 'Kangal', 'Koyulhisar', 'Şarkışla', 'Sivas Merkez', 'Suşehri', 'Ulaş', 'Yıldızeli', 'Zara',
  ],
  Tekirdağ: [
  ...
  Yozgat: [
    ...
    'Saraykent', 'Sarıkaya', 'Şefaatli', 'Sorgun', 'Yenifakılı', 'Yerköy', 'Yozgat Merkez',
  ],
  Zonguldak: [
    'Alaplı', 'Çaycuma', 'Devrek', 'Ereğli', 'Gökçebey', 'Kilimli', 'Kozlu', 'Zonguldak Merkez',
  ],
  Aksaray: [
  ...
  Kırıkkale: [
    'Bahşili', 'Balışeyh', 'Çelebi', 'Delice', 'Karakeçili', 'Keskin', 'Kırıkkale Merkez', 'Sulakyurt', 'Yahşihan',
  ],
  Batman: [
  ...
  Düzce: ['Akçakoca', 'Cumayeri', 'Çilimli', 'Düzce Merkez', 'Gümüşova', 'Gölyaka', 'Kaynaşlı', 'Yığılca'],
}
