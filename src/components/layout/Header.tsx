        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
          ...
          {!session ? (
            <>
              ...
              <Link href="/auth/register" style={{ padding: '0 16px', height: 38, borderRadius: 10, fontSize: 13.5, fontWeight: 700, color: 'white', textDecoration: 'none', background: 'var(--brand)', display: 'flex', alignItems: 'center', whiteSpace: 'nowrap' }}>
                Kayıt Ol
              </Link>
            </>
          ) : (
